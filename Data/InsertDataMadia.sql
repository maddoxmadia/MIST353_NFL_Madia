...
-- Schedule AFC Championship (GameID 11)
...
-- Enter scores for AFC Championship - Patriots win 10-7
...
-- Schedule NFC Championship (GameID 12)
execute procScheduleGame
    @HomeTeamID = 32,
    @AwayTeamID = 30,
    @GameRound = 'Conference',
...
-- Enter scores for NFC Championship - Seahawks win 31-27
execute procEnterScores
    @GameID = 12,
    @HomeTeamScore = 31,
    @AwayTeamScore = 27,
...
-- Enter scores for Super Bowl - Seahawks win 29-13
execute procEnterScores
    @GameID = 13,
    @HomeTeamScore = 29,
    @AwayTeamScore = 13,
